...
namespace Skoruba.IdentityServer4.STS.Identity.IntegrationTests.Mocks
{
    public static class UserMocks
    {
        ...
        public static string PreviousFormState = "true";
        ...
        public static Dictionary<string, string> GenerateLoginData(string userName, string password, string previousFormState, string antiForgeryToken)
        {
